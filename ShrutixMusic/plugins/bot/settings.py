...
async def send_repo(_, message: Message):
    await message.reply_video(
        ...
        caption=(
            ...
            "🧡 ᴄʀᴇᴅɪᴛꜱ : <a href='https://t.me/govoBots'>@GovoBots</a>"
        ),
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("🎵 Music + Management Bot Repo", url="https://t.me/govoBots")],
                [InlineKeyboardButton("🎧 Only Music Bot Repo", url="https://t.me/govoBots")]
            ]
        ),
